...
<div class="col-md-3"></div>
                                    <div class="col-md-7 custom-list">
                                        <div class="btn-group pull-right">
                                            <button id="sample_editable_1_new" class="btn custom-button"><a class="add-link" href="bloglist">
                                            Blog List <i class="fa fa-list"></i></a>
                                            </button>
                                        </div>
...
<br>
                                        <form class="w3-container" method="post" action="addBlog" enctype="multipart/form-data">
                                            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                            <div class="form-group">
                                                <label>Blog Title</label>
                                                <input class="w3-input" type="text" name="blog_title">
                                            </div>

                                            <div class="form-group">
                                                <label>Description</label>
                                                <textarea name="description" class="w3-input" id="editor"></textarea>                                                
                                            </div>
                                            <div class="form-group">
                                                <label>ImageBig</label>
                                                <input class="w3-input" type="file" name="ImageBig">
                                            </div>
                                            <div class="form-group">
                                                <label>ImageSmall</label>
                                                <input class="w3-input" type="file" name="ImageSmall">
                                            </div>

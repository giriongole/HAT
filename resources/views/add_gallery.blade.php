 ...
 <div class="col-md-3"></div>
                                    <div class="col-md-7 custom-list">
                                        <div class="btn-group pull-right">
                                            <button id="sample_editable_1_new" class="btn custom-button"><a class="add-link" href="GalleryList">
                                            List <i class="fa fa-list"></i></a>
                                            </button>
                                        </div>
...
<br>
                                        <form class="w3-container" method="post" action="addGallery" enctype="multipart/form-data">
                                            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                            <div class="form-group">                                             
                                               
                                                <select id='cat_name1' name="cat_id" class="w3-select">
                                                    <option selected>Category Id</option>
                                                   <?php 
                                                   foreach ($place_cat as $value) {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="editor" class="w3-input"></textarea>                                                
                                            </div>
                                            <div class="form-group">
                                                <label>Image</label>
...
<![endif]-->
    ...
    <script type="text/javascript">
        ...
        $('#cat_name1').click(function (){
            
        $.ajax({
            type:'POST',
            url:'http://localhost/vegavaram/public/getmsg',
            data:'_token=<?php echo csrf_token()?>',
            success:function  (data) {
               
            }
                //$("#msg").append("<option>arun</option>");

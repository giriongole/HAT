                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box  custome-portlet">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-plus"></i>Add Persons
                                </div>
 ...
 <div class="col-md-3"></div>
                                    <div class="col-md-7 custom-list">
                                        <div class="btn-group pull-right">
                                            <button id="sample_editable_1_new" class="btn custom-button"><a class="add-link" href="user-list">
                                            Persons List <i class="fa fa-list"></i></a>
                                            </button>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="w3-card-4" style="margin:20px ;background:#f1f1f1;padding-bottom:20px;">
                                        ...
                                        <form class="w3-container" method="post" action="addPersons" enctype="multipart/form-data">
                                            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                            <div class="form-group">                                             
                                               <br>
                                                <select id='cat_name1' name="person_cat_id" class="w3-select">
                                                    <option selected>Persons category</option>
                                                    <?php
                                                        foreach ($dbidies as $value) {
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="text" name="person_name" class="w3-input"/>                                                
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="qualification" class="w3-input"></textarea>                                                
                                            </div>
                                            <div class="form-group">
                                                <label>Image</label>

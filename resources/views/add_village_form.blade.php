            ...
            <div class="page-content custome-page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#">Add Non Support Devices</a>
                        </li>
                    </ul>
                </div>
                <!-- END PAGE HEADER-->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box  custome-portlet">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-plus"></i>Add Non Support Devices
                                </div>
   ...
   <div class="col-md-3"></div>
                                    ...
                                    <div class="col-md-7 custom-list">
                                        <div class="btn-group pull-right">
                                            <button id="sample_editable_1_new" class="btn custom-button"><a class="add-link" href="villageList">
                                            Non Support Devices <i class="fa fa-list"></i></a>
                                            </button>
                                        </div>
...
<br>
                                        <form class="w3-container" method="post" action="addvillagedata" enctype="multipart/form-data">
                                            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                            <div class="form-group">
                                                <label> Non Support Devices Name</label>
                                                <input class="w3-input" type="text" name="village_name">
                                            </div>
                                            <div class="form-group">
                                                <label> Description</label>
                                                <textarea id="editor" class="w3-input" type="text" name="description"></textarea>
                                            </div>

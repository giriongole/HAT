...
<body class="page-header-fixed page-quick-sidebar-over-content page-style-square">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box  custome-portlet">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-plus"></i>Add Not Supported Devices
                                </div>
 ...
 <div class="col-md-3"></div>
                                        ...
                                        <div class="col-md-12">
                                            <button id="sample_editable_1_new" class="btn custom-button pull-right">
                                            <a class="add-link" href="Nonsupportdevices-list">
                                            Not Supported Devices List <i class="fa fa-list"></i></a>
                                        </button>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="w3-card-4" style="margin:20px;background:#f1f1f1;padding-bottom:20px;">
                                        ...
                                        <form class="w3-container" method="post" action="Nonsupportdevices" enctype="multipart/form-data">

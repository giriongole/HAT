            ...
            <div class="page-content custome-page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#">Supported Device list</a>
                        </li>
                    </ul>
                </div>
                <!-- END PAGE HEADER-->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box custome-portlet ">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-globe"></i> Supported Device list
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="btn-group pull-right">
                                                <a href="SupportedDevices" id="sample_editable_1_new" class="btn green custom-button">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">                                            
                                            ...
                                            foreach ($dbresult as $value) {
                                                ...
                                                echo'<td class="active-order-data">'.$value->description.'</td>';
                                                echo'<td class="active-order-data">'.$value->dname.'</td>';
                                                echo'<td class="active-order-data">'.$value->cost.'</td>';
                                                echo'<td class="active-order-data">'.$value->installation_cost.'</td>';
                                                ...
                                                echo'<td class="active-order-data"><a href="delete-persons/'.$value->id.'"><button class="btn btn-danger view-button center-block"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp&nbspDelete</button></a></td></tr>';
                                                }
                                            ?>

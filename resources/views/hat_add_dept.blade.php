                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box  custome-portlet">
                           ...
                           <div class="col-md-12">
                                ...
                                <button id="sample_editable_1_new" class="btn custom-button"><a class="add-link" href="Departments">
                                Department List <i class="fa fa-list"></i></a>
                                </button>
                            </div>
                           </div>
...
<br>
                                        <form class="w3-container" method="post" action="addDepartment" enctype="multipart/form-data">
                                            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                            <div class="form-group">
                                                <label>Department Name</label>
                                                <input class="w3-input" type="text" name="cat_name">
                                            </div>

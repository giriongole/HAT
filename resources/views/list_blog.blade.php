                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box custome-portlet ">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-globe"></i>Blog List
                                </div>
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            foreach ($dbresult as $value) {
                                                ...
                                                echo'<td class="active-order-data"><a href="delete-blog/'.$value->id.'"><button type="submit" class="btn btn-danger view-button center-block"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp&nbspDelete</button></a></td><tr/>
                                                ';                                                
                                                }
                                            ?>

                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">                                            
                                            ...
                                            foreach ($dbresult as $value) {
                                                ...
                                                echo'<td class="active-order-data"><a href="delete-gallery/'.$value->id.'"><button class="btn btn-danger view-button center-block"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp&nbspDelete</button></a></td><tr/>';
                                                }
                                            ?>

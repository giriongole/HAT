                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box custome-portlet ">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-globe"></i>News/Events List
                                </div>
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            foreach ($dbresult as $value) {
                                                ...
                                                echo'<td class="active-order-data">'.$value->title.'</td>';
                                                echo'<td class="active-order-data">'.$value->description.'</td>';
                                                echo'<td class="active-order-data">'.$value->event_place.'</td>';
                                                echo'<td class="active-order-data">'.$value->contact_num.'</td>';
                                                ...
                                                echo'<td class="active-order-data"><a href="delete-newsEvents/'.$value->id.'"><button class="btn btn-danger view-button center-block"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp&nbspDelete</button></a></td><tr/>';
                                                }
                                            ?>

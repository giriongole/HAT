                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box custome-portlet ">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-globe"></i>Place Category List
                                </div>
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">                                            
                                            ...
                                            foreach ($dbresult as $value) {
                                                ...
                                                echo'<td class="active-order-data">'.$value->updated_on.'</td>';
                                                ...
                                                echo'<td class="active-order-data"><a href="delete-placeCategory/'.$value->id.'"><button class="btn btn-danger view-button center-block"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp&nbspDelete</button></td><tr/>';
                                                }
                                            ?>

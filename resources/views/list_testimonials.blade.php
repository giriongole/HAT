                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box custome-portlet ">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-globe"></i>Testmonials List
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="btn-group pull-right">
                                                <button id="sample_editable_1_new" class="btn green custom-button">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            foreach ($dbresult as $value) {
                                                ...
                                                echo'<td class="active-order-data">'.$value->client_name.'</td>';
                                                echo'<td class="active-order-data">'.$value->description.'</td>';
                                                echo'<td class="active-order-data">'.$value->client_qualification.'</td>';
                                                echo'<td class="active-order-data">'.$value->created_on.'</td>';
                                                ...
                                                echo'<td class="active-order-data"><a href="delete-testimonials/'.$value->id.'"><button class="btn btn-danger view-button center-block"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp&nbspDelete</button></a></td><tr/>';
                                                }
                                            ?>

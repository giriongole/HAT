                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box custome-portlet ">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-globe"></i>village List
                                </div>
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">                                            
                                            ...
                                            foreach ($dbresult as $value) {
                                                ...
                                                echo'<td class="active-order-data">'.$value->village_name.'</td>';
                                                echo'<td class="active-order-data">'.$value->mandal.'</td>';
                                                echo'<td class="active-order-data">'.$value->district.'</td>';
                                                ...
                                                echo'<td class="active-order-data"><button class="btn btn-danger view-button center-block"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp&nbspDelete</button></td><tr/>';
                                                }
                                            ?>
